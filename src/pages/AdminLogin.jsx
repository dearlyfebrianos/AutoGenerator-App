...
const AdminLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      if (username === "dearly" && password === "dearly123") {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transform hover:scale-[1.02] transition-transform duration-300">
          {/* Logo/Icon */}
